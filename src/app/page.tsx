      ...
      <section className='popular w-full flex flex-col gap-4'>
        ...
        <div className='sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
          <Card className='w-full max-w-[304px] mx-auto h-auto flex flex-col justify-between'>
            ...
            <CardContent className='w-full flex flex-col items-center justify-center gap-4'>
              <Image src={"/Car light gry.png"} alt='' width={220} height={68} />
              <Image
                src={"/Spesification.png"}
                alt=''
                width={256}
          ...
          <Card className='w-full max-w-[304px] mx-auto h-auto flex flex-col justify-between'>
            ...
            <CardContent className='w-full flex flex-col items-center justify-center gap-4'>
              <Image src={"/car black.png"} alt='' width={220} height={68} />
              <Image
                src={"/Spesification.png"}
                alt=''
                width={256}
        ...
        <div className='sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
          <Card className='w-full max-w-[304px] mx-auto h-auto flex flex-col justify-between'>
            ...
            <CardContent className='w-full flex flex-col items-center justify-center gap-4'>
              <Image src={"/car sky.png"} alt='' width={220} height={68} />
              <Image
                src={"/Spesification.png"}
                alt=''
                width={256}
          ...
          <Card className='w-full max-w-[304px] mx-auto h-auto flex flex-col justify-between'>
            ...
            <CardContent className='w-full flex flex-col items-center justify-center gap-4'>
              <Image src={"/car white.png"} alt='' width={220} height={68} />
              <Image
                src={"/Spesification.png"}
                alt=''
                width={256}
